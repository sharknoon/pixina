  ...
  <div id="place-wrapper" class="h-100 d-flex flex-column">
    ...
    <div class="d-flex justify-content-between p-4">
      <div class="btn-group me-2" role="group" aria-label="Image type">
        <input id="btn-check-original" v-model="variant" type="radio" class="btn-check" autocomplete="off"
        ...
        <input id="btn-check-cleaned" v-model="variant" type="radio" class="btn-check" autocomplete="off"
          value="cleaned" />
      ...
      <div>
        <input id="btn-check-grid" v-model="grid" type="checkbox" class="btn-check" autocomplete="off" />
        <label class="btn btn-secondary" for="btn-check-grid">
          <svg v-if="grid" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
            <path
