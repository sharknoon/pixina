...
function drawPlateCanvas() {
  ...
  c.width = 1000;
  c.height = 1000;
  const ctx: CanvasRenderingContext2D = c.getContext(
    "2d",
  ...
  const amountPixelsPerColumn: number =
    amountRows * amountPixelsPerSquareColumn;
