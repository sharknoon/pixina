<template>
  <div class="p-4">
    ...
    <p>
      ...
      die Daten nur in Drittländern mit einem anerkannten Datenschutzniveau
      (Art. 45 DSGVO), beim Vorliegen und Einhaltung vertraglichen Verpflichtung
      durch sogenannte Standardschutzklauseln der EU-Kommission (Art. 46 DSGVO)
      oder beim Vorliegen von Zertifizierungen oder verbindlicher internen
    ...
    <p>
      ...
      auch die Funktionalität unseres Onlineangebotes eingeschränkt sein kann).
